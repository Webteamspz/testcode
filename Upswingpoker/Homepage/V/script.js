var convertInterval = setInterval(function() {
    if (typeof convert != 'undefined') {
		...
		try{
		    ...
		    function loadTest() {
		    	var slider = '<div class="player-info"><div class="inner-wrap"><span class="player-one">Rayan Fee</span><span class="player-two">Doug Polk</span></div></div><div class="slider-section"><div class="title-wrap"><span class="heading">AS SEEN ON</span></div><div class="inner-wrap"><div class="slider-wrap"><img class="img-logo" src="https://iili.io/HrW1PEv.png" alt="client Logos"></div></div></div>'
