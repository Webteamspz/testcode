var saCheckout = {
    ...
    mainJS: function() {
        ...
        var saCheckoutBanner = `<div class="saCheckoutBannerWrap"><div class="inner-wrap"><a href="/" class="main-logo"><img src="https://iili.io/H6nXTu9.png" alt="Safishing"></a></div></div>`;
		...
		var whyBuyHtml = `<div class="whyBuyWrap"><div class="wraper-3 wraper-x"><div class="list"><div class="list-item"><div class="img-block"><img src="https://iili.io/H6nXzy7.png" alt="3M+ Happy Customers"></div><p>3M+ Happy <br/>Customers</p></div><div class="list-item"><div class="img-block"><img src="https://iili.io/H6nXxvS.png" alt="Easy Return and Exchanges"></div><p>Easy Return & <br/>Exchanges</p></div><div class="list-item"><div class="img-block"><img src="https://iili.io/H6nXoa2.png" alt="Fast Shipping within 1-3 days"></div><p>Fast Shipping <br/>with Tracking</p></div></div></div>`;
