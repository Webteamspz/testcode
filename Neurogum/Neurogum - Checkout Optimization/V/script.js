var neCheckout = {
    ...
    mainJS: function() {
        ...
        var neCheckoutBanner = `<div class="neCheckoutBannerWrap"><div class="inner-wrap"><a href="/"><img class="left-logo" src="https://iili.io/HSMn26v.png" alt="Neurogum"></a><div class="inner-slider"></div><div class="hero-review"><img src="https://iili.io/H8MMfwB.png" alt="5 Stars"><p class="title">Join 200,000+ Happy Customers</p></div><picture><source media="(min-width: 999px)" srcset="https://iili.io/HSMnFFR.png"><source media="(min-width: 310px)" srcset="https://iili.io/HSMI3xt.png"><img class="right-logo" src="https://iili.io/HSMnFFR.png" alt="Engagedly Product"></picture></div></div>`;
